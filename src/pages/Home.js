        ...
        <div className='flex flex-col items-center justify-center pb-8 border-t-2 border-purple-200'>
          ...
          <div className='w-2/3 bg-purple-200 border-2 border-purple-400 rounded-lg'>
            <p className='flex justify-center mx-4 my-2 text-justify text-gray-700'>
              A progressive web application (PWA) that allows
              teachers/instructors to post homework (quiz or attendance) simply
              by opening the website and generating a link for the new homework
              page. This link could then be shared with students to submit their
              solutions. Furthermore, the proposed tool allows creating
              different types of quizzes with an auto grading system. Submitted
              homeworks and quizzes by the registered users will pass face
              recognition to avoid submitting an assignment for another person.
              Another functionality of the system is in-class attendance
              checking mechanism using QR codes or a generated link ID. In the
              second case, the teacher/instructor can tick one or more required
              functionalities and this check will be added into the link.{' '}
            </p>
          </div>
        </div>
        <Steps />
