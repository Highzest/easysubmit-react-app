              ...
              <div className='flex flex-col items-start flex-grow pl-6 md:pl-8 sm:items-center sm:flex-row'>
                <div className='flex-grow mt-6 sm:pl-6 sm:mt-0'>
                  <h2 className='mb-1 text-xl font-medium text-purple-700 title-font'>
                    Choose type of the assignment
                  </h2>
                  <p className='leading-relaxed'>
                    Create a homework (quiz or attendance) page by clicking on
                    the corresponding button on the Home page
                  </p>
                </div>
              </div>
            </div>
            <div className='relative flex pb-20 mx-auto sm:items-center md:w-2/3'>
              ...
              <div className='flex flex-col items-start flex-grow pl-6 md:pl-8 sm:items-center sm:flex-row'>
                <div className='flex-grow mt-6 sm:pl-6 sm:mt-0'>
                  ...
                  <p className='leading-relaxed'>
                    Enter the title and the description of the assignment.
            ...
            <div className='relative flex pb-20 mx-auto sm:items-center md:w-2/3'>
              ...
              <div className='flex flex-col items-start flex-grow pl-6 md:pl-8 sm:items-center sm:flex-row'>
                <div className='flex-grow mt-6 sm:pl-6 sm:mt-0'>
                  ...
                  <p className='leading-relaxed'>
                    Click on the button to generate a link for the homework
                    (quiz or attendance) page and new page will be created.
                  </p>
                </div>
              </div>
            </div>
